        ...
        <div className="pt-16 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[640px] py-12 md:py-20 md:min-h-[480px]">
              ...
              Make quick, cheap and secure payments with Global Gates, all powered by stablecoins on the XRPL.
              </p>
                      ...
                      >
                      <div>
                        <Link className="btn text-white bg-blue-500 hover:bg-blue-600 group shadow-sm rounded-lg" href="/user">
                        Get Started{' '}
                ...
                {/* <div className="sm:flex sm:items-center sm:justify-center space-y-2 sm:space-y-0 sm:space-x-3">
                  <div className="inline-flex -space-x-3 -ml-0.5">
                    <Image className="rounded-full border-2 border-slate-800 box-content" src={Avatar01} width={28} height={28} alt="Avatar 01" />
                    <Image className="rounded-full border-2 border-slate-800 box-content" src={Avatar02} width={28} height={28} alt="Avatar 02" />
                    <Image className="rounded-full border-2 border-slate-800 box-content" src={Avatar03} width={28} height={28} alt="Avatar 03" />
                    <Image className="rounded-full border-2 border-slate-800 box-content" src={Avatar04} width={28} height={28} alt="Avatar 04" />
                  </div>
            ...
            <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[40rem] md:top-1/2 md:-translate-y-1/2 md:ml-8 lg:ml-20 xl:ml-32">
              <div data-aos="fade-left" data-aos-duration="1100">
                <Image src={iPhone} className="md:max-w-none" width={298} height={601} priority alt="iPhone" />
              </div>
            </div>
          </div>
        </div>

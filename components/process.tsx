        ...
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2">Transparency</h4>
              <p className="text-lg text-gray-400 text-center">Enjoy open and competitive exchange rates automatically adjusted by the market itself.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <p className="text-lg text-gray-400 text-center">Our transactions are lightning-fast—completed in seconds, not days, unlike traditional bank transfers.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <p className="text-lg text-gray-400 text-center">Unlike other banking apps, you have complete control of your money, securely stored in your own wallet, not on centralized servers</p>
            </div>
